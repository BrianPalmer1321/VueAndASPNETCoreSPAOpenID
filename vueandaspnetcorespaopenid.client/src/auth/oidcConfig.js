...
export const oidcConfig = {
  ...
  //client_id: 'SP_AST_MAUI_LOCALHOST_8070_CSSC_QA',
  //client_id: 'SP_AST_HANDSCORING_LOCALHOST_MAUI_OIDC_QA',
  //client_id: 'SP_AST_MAUI_HANDSCORINGCENTRAL_OIDC_UAT',
  //client_id: 'SP_LOCALHOST_HANDSCORINGCENTRAL_OIDC_UAT',
  //client_id: 'SP_AST_LOCALHOST_OIDC_MAUI_QA',
  //client_id: 'SP_ANALYSISLOCALHOST_ANALYSIS_QA',
